...
_$VictoryImpl _$$VictoryImplFromJson(Map<String, dynamic> json) =>
    _$VictoryImpl(
      defeatedEnemy:
          EnemyModel.fromJson(json['defeatedEnemy'] as Map<String, dynamic>),
...
_$WrongClaimImpl _$$WrongClaimImplFromJson(Map<String, dynamic> json) =>
    _$WrongClaimImpl(
      penalty:
          PenaltyRecordModel.fromJson(json['penalty'] as Map<String, dynamic>),
      currentEnemy:
          EnemyModel.fromJson(json['currentEnemy'] as Map<String, dynamic>),
      $type: json['runtimeType'] as String?,
    );
